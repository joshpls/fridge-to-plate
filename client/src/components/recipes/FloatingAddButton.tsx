        ...
        <>
            {isAuthenticated &&
                <button
                    ...
                    className="fixed bottom-10 right-10 z-50 group flex items-center gap-2 bg-gray-900 dark:bg-orange-500 text-white p-4 rounded-2xl shadow-2xl shadow-orange-200 dark:shadow-none hover:bg-orange-500 dark:hover:bg-orange-600 hover:scale-110 active:scale-95 transition-all duration-300"
